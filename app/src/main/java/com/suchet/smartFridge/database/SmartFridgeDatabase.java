...
@Database(entities = {User.class, Food.class, Meal.class, ShoppingItem.class},version = 1,exportSchema = false)
...
public abstract class SmartFridgeDatabase extends RoomDatabase {
    ...
    public static final String SHOPPING_ITEM_TABLE = "shopping_item_table";
